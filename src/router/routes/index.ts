...
export const routesSidebar: MyRouteRecordRaw[] = [
    ...
    children: [
      {
        ...
        name: "split-button",
        component: () =>
          import("@/modules/buttons/split-buttons/layouts/SplitButtonsLayout.vue"),
        meta: {
          title: "Split Button",
          icon: "view_agenda",
          keyword: ["split"],
        ...
        children: [
          {
            ...
            path: "split-button-1",
            component: () =>
              import("@/modules/buttons/split-buttons/components/SplitButton1.vue"),
            meta: {
          ...
          },
          {
            ...
            name: "split-button-2",
            component: () =>
              import("@/modules/buttons/split-buttons/components/SplitButton2.vue"),
            meta: {
      ...
      },
      {
        ...
        name: "loading-button",
        component: () =>
          import("@/modules/buttons/buttons-loading/layouts/ButtonLoadingLayout.vue"),
        meta: {
      ...
      },
      {
        ...
        name: "action-button",
        component: () =>
          import("@/modules/buttons/buttons-action/layouts/ButtonsActionLayout.vue"),
        ...
        children: [
          {
            ...
            component: () =>
              import("@/modules/buttons/buttons-action/components/CustomButtonAction.vue"),
            meta: {
    ...
    children: [
      {
        ...
        name: "get-profiles",
        component: () =>
          import("@/modules/profiles/components/GetProfiles.vue"),
        meta: {
          title: "Perfiles",
          icon: "group",
          keyword: ["perfiles", "perfil"],
      ...
      },
      {
        ...
        name: "profile-edit",
        component: () =>
          import("@/modules/profiles/components/EditProfile.vue"),
        props: true,
        meta: {
          title: "Editar Perfil",
          icon: "edit",
  ...
  },
  {
    ...
    name: "websocket",
    component: () =>
      import("@/modules/web-sockets/layouts/WebsocketLayout.vue"),
    meta: {
      title: "Websocket",
      icon: "refresh",
      keyword: ["websocket"],
    ...
    children: [
      {
        ...
        component: () =>
          import("@/modules/web-sockets/components/IndexLayout.vue"),
        meta: {
        ...
        children: [
          {
            ...
            component: () =>
              import("@/modules/web-sockets/components/IndexComponent.vue"),
            meta: {
          ...
          },
          {
            ...
            component: () =>
              import("@/modules/web-sockets/components/IndexInter.vue"),
            meta: {
          ...
          },
          {
            ...
            name: "websocket-desk",
            component: () =>
              import("@/modules/web-sockets/components/Desk.vue"),
            props: true,
            meta: {
      ...
      },
      {
        ...
        component: () =>
          import("@/modules/web-sockets/components/NewTicket.vue"),
        meta: {
  ...
  },
  {
    ...
    name: "versions",
    component: () =>
      import("@/modules/update-apk/all-versions/layout/AllVersionsLayout.vue"),
    meta: {
      title: "Versiones",
    ...
    children: [
      {
        ...
        name: "dashboard",
        component: () =>
          import("@/modules/dashboard/layout/DashboardLayout.vue"),
