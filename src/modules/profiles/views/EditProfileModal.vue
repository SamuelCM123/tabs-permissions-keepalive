...
<template>
    ...
    >
        ...
        <template #header>
            ...
            <h1 class="title-modal" :title="props.nameProfile">EDITAR PERFIL {{ props.nameProfile }}</h1>
        ...
        <template #body>
            ...
            <div class="container-description-modal">
                ...
                <span class="description-modal">
                    <p>Al editar el perfil, es necesario cerrar sesiones a los usuarios activos relacionados, considere que hay:</p>
                    <p>
